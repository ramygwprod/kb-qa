...
**Version 6.13.2** · for operators and for maker agents
...
pip install "git+https://github.com/ramygwprod/kb-qa.git@v6.13.2"
...
python -m kbqa --version          # must print 6.13.2
```
...
frontmatter and holds no rows. Before 6.13.2 it was counted as a batch, so
