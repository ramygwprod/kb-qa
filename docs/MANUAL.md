...
**Version 6.11.0** · for operators and for maker agents
...
pip install "git+https://github.com/ramygwprod/kb-qa.git@v6.11.0"
python -m kbqa --version          # must print 6.11.0
```
...
frontmatter and holds no rows. Before 6.11.0 it was counted as a batch, so
