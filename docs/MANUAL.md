...
**Version 6.13.1** · for operators and for maker agents
...
pip install "git+https://github.com/ramygwprod/kb-qa.git@v6.13.1"
...
python -m kbqa --version          # must print 6.13.1
```
...
frontmatter and holds no rows. Before 6.13.1 it was counted as a batch, so
